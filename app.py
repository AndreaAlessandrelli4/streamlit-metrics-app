...
def display_metrics(metrics1, metrics2, path):
    ...
    colors1 = [cmaps.BlGrYeOrReVi200_r(val) for val in filtered_df["Valore1"]]  # Prima barra
    colors2 = [cmaps.BlGrYeOrReVi200_r(val) for val in filtered_df["Valore2"]]  # Seconda barra
